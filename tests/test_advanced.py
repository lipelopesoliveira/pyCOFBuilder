...
class AdvancedToolsTest(unittest.TestCase):
    """Advanced test of Tools module."""
...
class AdvancedIOToolsTest(unittest.TestCase):
    """Advanced test of IO_Tools module."""

    def test_read_cif(self):
        pass


class AdvancedCJsonTest(unittest.TestCase):
    """Advanced test of IO_Tools module."""
...
class AdvancedBuildBlockTest(unittest.TestCase):
    """Advanced test of IO_Tools module."""
...
class AdvancedFrameworkTest(unittest.TestCase):
    """Advanced test of IO_Tools module."""
