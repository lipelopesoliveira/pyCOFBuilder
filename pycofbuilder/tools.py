...
def elements_dict(prop='mass'):
    ...
    mass = {'H': 1.00794, 'He': 4.002602, 'Li': 6.941, 'Be': 9.012182, 'B': 10.811, 'C': 12.0107, 'N': 14.0067,
              ...
              'X': 0.0, 'Q': 0.0, 'R': 0.0, 'R1': 0.0, 'R2': 0.0, 'R3': 0.0, 'R4': 0.0, 'R5': 0.0, 'R6': 0.0, '0':0.0 }
    ...
    'Kr': 3.23, 'Xe': 3.02, 'Rn': 2.81,'X': 0.0, 'Q': 0.0, 'R': 0.0, 'R1': 0.0,
     'R2': 0.0, 'R3': 0.0, 'R4': 0.0, 'R5': 0.0, 'R6': 0.0, '0':0.0 }
    ...
    out = {'mass':mass, 'atomic_number':atomic_number, 'polarizability':polarizability, 'pauling':pauling, 
